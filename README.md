...
## Setup
The setup is designed for an Ubuntu/Linux setup with VS Code installed. For a full-detailed step-by-step setup, please refer to the Documentation channel on Teams, otherwise continue to see the following summarised steps (please note that the VS Code extensions are optional, but recommended):
 - Repo
 ...
 - VS Code (OPTIONAL, and only if this is a fresh install of Ubuntu/Linux) 
