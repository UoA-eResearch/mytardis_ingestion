...
from src.mytardis_client import helpers as mt_helpers
...
class Conveyor:
    ...
    def create_replica(self, file: Datafile) -> DatafileReplica:
        ...
        dataset_id = mt_helpers.resource_uri_to_id(file.dataset)
    ...
    def transfer(self, data_root: Path, dfs: list[Datafile]) -> None:
        ...
        for df in dfs:
            ...
            dataset_id = mt_helpers.resource_uri_to_id(df.dataset)
