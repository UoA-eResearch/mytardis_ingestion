...
def test_beneficiate():
    ...
    assert df.metadata and df.metadata["Image|Pixels|Channel|Channel:0:0|PinholeSizeUnit"] == "um"
    assert df.metadata and df.metadata["Image|Pixels|Channel|Channel:0:1|PinholeSizeUnit"] == "um"
