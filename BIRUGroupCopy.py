from Core.factory import IngestionFactory
...
class BIRUIngestFactory(IngestionFactory):
    ...
    def __init__(self,
        ...
        self.datafile_json_path = datafile_json_path
    ...
    def process_datafile_input(self):
        datafile_dict = readJSON(self.datafile_json_path)
        datafile_list = []
        schema = datafile_dict['schema']
        storage_box = datafile_dict['storage_box']
        for datafile in datafile_dict['datafiles']:
            datafile['schema'] = schema
            datafile['storage_box'] = storage_box
