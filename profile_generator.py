...
class ProfileGenerator:
    ...
    def _create_profile_folder(
        ...
        org_const_fn = "_consts.py"
        org_const_fp = os.path.join(dst, org_const_fn)
        new_const_fn = profile_name + org_const_fn
        new_const_fp = os.path.join(dst, new_const_fn)
        os.rename(org_const_fp, new_const_fp)
        return dst
    ...
    def _generate_raw_dataclass_dict(self,
        ...
        for key in fields_dict.keys():
            ...
            entry_dict = ph.create_dataclass_entry_dict()
